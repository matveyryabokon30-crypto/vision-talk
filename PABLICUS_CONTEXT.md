...
**Открытый вход ещё IN_PROGRESS.** Публичная passkey-регистрация уже включена отдельно от `publicSignupReady=false`, относящегося к почтовому пути. Settings и health проверены; новое создание аккаунта, повторный вход и межустройственная проверка ещё не подтверждены. Нельзя включать все профили массово или считать `mailer_autoconfirm=true` проверкой владения email. Следующий ограниченный исполнительский цикл — квалификация существующего passkey и конкретное улучшение доступа, затем проверка и фиксация. Исследование не закрывает физические регрессии ниже и не завершает всё поручение.
