...
(() => {'use strict';
 ...
 passwordLogin=PablicusLogin.mount({client:sb,recoveryClient,projectUrl:URL,canSignIn:()=>!passkeySigninActive,authenticate:session=>{trustExplicitSignIn();return authenticate(session)}});
