...
h=h.replace('<script src="app.js">','<script src="media-viewer.js"></script><script src="inbox-monitor.js"></script><script src="app.js">')
h=h.replace('</head>','<link rel="stylesheet" href="media-viewer.css"><link rel="stylesheet" href="inbox-monitor.css"></head>')
