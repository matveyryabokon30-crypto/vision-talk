...
h=h.replace('</head>', '<link rel="manifest" href="manifest.webmanifest"><link rel="apple-touch-icon" href="assets/icon-glass-20260909-180.png"><link rel="icon" href="assets/icon-glass-20260909-32.png"><meta name="apple-mobile-web-app-capable" content="yes"><meta name="apple-mobile-web-app-title" content="Pablicus"><meta name="apple-mobile-web-app-status-bar-style" content="default"><link rel="stylesheet" href="pablicus.css"></head>')
...
h=h.replace('<script src="app.js">','<script src="workspace-editor.js"></script><script src="media-viewer.js"></script><script src="inbox-monitor.js"></script><script src="people.js"></script><script src="chat-actions.js"></script><script src="push-notifications.js"></script><script src="chat-library.js"></script><script src="chat-canvas.js"></script><script src="tasks-home.js"></script><script src="workspace-quick.js"></script><script src="app.js">')
h=h.replace('</head>','<link rel="stylesheet" href="workspace-editor.css"><link rel="stylesheet" href="media-viewer.css"><link rel="stylesheet" href="inbox-monitor.css"><link rel="stylesheet" href="message-menu.css"><link rel="stylesheet" href="people.css"><link rel="stylesheet" href="chat-actions.css"><link rel="stylesheet" href="chat-minimal.css"><link rel="stylesheet" href="profile-discovery.css"><link rel="stylesheet" href="chat-library.css"><link rel="stylesheet" href="chat-canvas.css"><link rel="stylesheet" href="tasks-home.css"><link rel="stylesheet" href="workspace-quick.css"></head>')
...
for n in ['workspace-editor.js','workspace-editor.css','workspace-quick.js','workspace-quick.css','tasks-home.js','tasks-home.css','chat-canvas.js','chat-canvas.css','chat-library.js','chat-library.css','message-menu.js','message-menu.css','people.js','people.css','chat-actions.js','chat-actions.css','chat-minimal.css','profile-discovery.css']:shutil.copy2(ROOT/'src'/n,OUT/n)
