...
h=h.replace('<script src="app.js">','<script src="media-viewer.js"></script><script src="inbox-monitor.js"></script><script src="people.js"></script><script src="chat-actions.js"></script><script src="app.js">')
