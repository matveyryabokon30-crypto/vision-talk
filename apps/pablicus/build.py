...
for n in ['tasks-home.js','tasks-home.css','chat-canvas.js','chat-canvas.css','chat-library.js','chat-library.css','message-menu.js','message-menu.css','people.js','people.css','chat-actions.js','chat-actions.css','chat-minimal.css','profile-discovery.css']:shutil.copy2(ROOT/'src'/n,OUT/n)
