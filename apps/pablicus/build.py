...
h=re.sub(r'<header>.*?</header>', '<header><button id="chatBack" aria-label="К чатам">‹</button><div class="chatHeading"><span class="chatSectionLabel">Чат</span><span id="chatTitle">Разговор</span><small id="chatHint" hidden></small></div><button id="queueBtn" hidden aria-hidden="true" tabindex="-1"></button><button id="reportBtn" aria-label="Исходящие сообщения"></button></header>',h,flags=re.S)
...
h=h.replace('<script src="app.js">','<script src="media-viewer.js"></script><script src="inbox-monitor.js"></script><script src="people.js"></script><script src="chat-actions.js"></script><script src="push-notifications.js"></script><script src="app.js">')
h=h.replace('</head>','<link rel="stylesheet" href="media-viewer.css"><link rel="stylesheet" href="inbox-monitor.css"><link rel="stylesheet" href="message-menu.css"><link rel="stylesheet" href="people.css"><link rel="stylesheet" href="chat-actions.css"><link rel="stylesheet" href="chat-minimal.css"><link rel="stylesheet" href="profile-discovery.css"></head>')
...
for n in ['message-menu.js','message-menu.css','people.js','people.css','chat-actions.js','chat-actions.css','chat-minimal.css','profile-discovery.css']:shutil.copy2(ROOT/'src'/n,OUT/n)
